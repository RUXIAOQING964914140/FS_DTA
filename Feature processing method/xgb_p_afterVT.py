...
xgbparams = {
    ...
    "max_depth": [3,4,5,6],
    #"eval_metric":['mean_squared_error','r2_score','mean_absolute_error'],
...
xgb_grid_search = GridSearchCV(xgb_m, xgbparams, cv=5,scoring='neg_mean_squared_error')
...
a = xgb_grid_search.best_params_
b = str(a)
with open("xgb_davis_p_afterVT.txt","w") as file:
    file.write(b)
